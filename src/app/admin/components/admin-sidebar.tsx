...
import { LayoutDashboard, Users, MessageSquare, Shield, CreditCard, Monitor, Sparkles, LogOut, Activity } from 'lucide-react';
    ...
    <nav className="w-52 shrink-0 flex flex-col h-full bg-black border-r border-zinc-800/70">
      <div className="px-4 h-14 flex items-center gap-2.5 border-b border-zinc-800/70">
        ...
        <div>
          ...
          <span className="ml-1.5 text-[9px] font-bold px-1 py-0.5 rounded bg-red-500/20 text-red-400 border border-red-500/30">INTERNAL</span>
        </div>
      </div>
      ...
      <div className="p-3 border-t border-zinc-800/70">
        ...
        <button
          ...
          className="flex items-center gap-2 text-xs text-zinc-500 hover:text-white transition-colors w-full px-1"
        >
